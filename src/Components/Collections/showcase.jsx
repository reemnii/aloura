    ...
    <main className="bg-[#fef6e9] text-[#5c4032] overflow-hidden">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-20">
        <section className="py-12 lg:py-16">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5 mb-8">
            <div>
              ...
              <h2 className="text-[clamp(2.5rem,3.2vw,4.5rem)] font-light mt-4 max-w-3xl">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-3">
            {Object.entries(filterGroups).map(([key, values]) => (
              <div
                key={key}
                className="rounded-[1.5rem] cursor-pointer border border-[#ac795a]/10 bg-white/75 p-4"
              >
                <div className="flex items-center justify-between gap-3 mb-4">
                  <label
                    htmlFor={`${key}-filter`}
                    className="text-[10px] cursor-pointer uppercase tracking-[0.3em] text-[#ac795a] font-sans"
                  >
                    {key}
                  </label>
                  ...
                  <button
                    ...
                    className="text-[10px] uppercase cursor-pointer tracking-[0.25em] text-[#5c4032]/45 hover:text-[#ac795a] transition-colors font-sans"
                  >
                    Clear
                  </button>
                </div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full cursor-pointer appearance-none rounded-full border border-[#ac795a]/15 bg-white px-4 py-3 pr-10 text-sm text-[#5c4032] outline-none transition-all duration-200 hover:border-[#ac795a]/30 focus:border-[#ac795a] focus:ring-2 focus:ring-[#ac795a]/15"
                  >
                    {values.map((value) => (
          ...
          <div className="mt-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="rounded-full border cursor-pointer border-[#ac795a]/15 bg-white px-4 py-2 text-sm outline-none"
              >
                  ...
                  {displayedMirrors.map((mirror) => (
                    ...
                    >
                      <div className="relative aspect-square overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-linear-to-t from-[#5c4032]/80 via-[#5c4032]/18 to-transparent" />
                      ...
                      <div className="p-6">
                        ...
                        <div className="mt-5 flex items-center justify-between gap-4">
                          ...
                          <Link
                            ...
                            className="btn-brown border-[#ac795a]/20 px-4 py-2 text-[10px] text-white"
                          >
                            View piece
                          </Link>
                        </div>
                ...
                {canLoadMore && (
                  <div className="mt-8 flex justify-center">
                    <button
                      ...
                      className="btn-brown border-[#ac795a]/20 px-6 py-3 text-sm text-white"
                    >
                      Load more
                    </button>
                  </div>
        ...
        <section className="py-2 pb-14">
          ...
          <h3 className="text-[clamp(1.75rem,2vw,2.75rem)] font-light mt-3 mb-6 max-w-3xl">
            The pieces people <span className="italic text-[#ac795a]"> come back for.</span>
          </h3>
