    ...
    <section className="pb-14 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-end mb-10">
          ...
          <span className="rounded-full border border-[#ac795a]/15 px-4 py-2 text-[10px] uppercase tracking-[0.28em] text-[#8f6348] font-sans w-fit">
        ...
        <div className="relative overflow-visible">
          ...
          <div className="overflow-hidden rounded-[2rem] shadow-[0_22px_70px_rgba(92,64,50,0.09)]">
            <Swiper
              spaceBetween={20}
              slidesPerView={1.05}
              onSwiper={(swiper) => {
